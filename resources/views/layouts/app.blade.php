        ...
        <header class="site-navbar mt-3">
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div style =" margin-top:0.8rem"class="site-logo col-6 d-xl-block ml-0 pl-0"><a style="text-decoration:none;" href="{{url('/')}}">JobBoard</a></div>
                        <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0" style="    text-align: center;">
